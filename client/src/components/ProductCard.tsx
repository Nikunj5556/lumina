...
export const ProductCard = ({ product, onAddToCart }: ProductCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-card rounded-2xl overflow-hidden border border-border shadow-sm hover:shadow-md transition-all duration-300"
    >
        ...
        <div className="p-4">
          <div className="flex justify-between items-start mb-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-[10px] font-bold text-muted-foreground">{dynamicRating}</span>
            </div>
          </div>
          <h3 className="text-sm font-semibold text-foreground line-clamp-1 mb-2 group-hover:text-foreground transition-colors">
            {product.name}
          </h3>
